...
/**
 * Report Animal (/rescue/report) scenario â€” PETZ_TC049 to PETZ_TC056.
 * Group: reportAnimal.
 */
public class ReportAnimalTest extends BaseTest {
    ...
    @Test(priority = 52,
          groups = {"reportAnimal", "functional", "regression", "negative"},
    ...
    public void TC055_ReportSubmitHappy() {
        ...
        page.clickSubmit();
        Waits.urlContains(driver, "/rescue");
    ...
    @Test(priority = 56,
          groups = {"reportAnimal", "functional", "regression", "sanity", "positive"},
    ...
    public void TC056_ReportBackButton() {
        ...
        page.open();
        page.clickBack();
        Waits.urlNotContaining(driver, "/rescue/report");
